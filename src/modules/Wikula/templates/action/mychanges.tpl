<div class="action_mychanges">
    ...
    <ul class="mychanges">
        ...
        <li>
            (<a href="{modurl modname='Wikula' type='user' func='main'    tag=$page.tag|urlencode time=$page.time|dateformat|urlencode}" title="{gt text='Revisions'}">{$page.timeformatted}</a>)
