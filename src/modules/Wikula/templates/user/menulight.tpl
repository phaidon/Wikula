<div class="z-clearfix">
    <ul class="z-menulinks" style="height: 24px;">
        <li>
            <a href="{modurl modname=$modinfo.name type='user' func='categories'}" title="{gt text='Categories'}">{gt text='Categories'}</a>
        </li>
        <li>
            <a href="{modurl modname=$modinfo.name type='user' func='show' __tag='Special_pages'}" title="{gt text='Special pages'}">{gt text='Special pages'}</a>
        </li>
