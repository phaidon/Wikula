    ...
    <div class="page">
        ...
        <div class="wikula_alignmiddle">
            ...
            <strong>
                ...
                {gt text='Edit'}
                {/if}
                <a href="{modurl modname='Wikula' func='main' tag=$tag time=$object.pageAtimeurl}" title="{$tag|safehtml} - {$object.pageAtime|dateformat|safehtml}">{$object.pageAtime|dateformat|safehtml}</a>
        ...
        <div class="wikula_alignmiddle">
            ...
            {useravatar uid=$uid}
            <strong>
                {gt text='Oldest known version of this page was edited on'} <a href="{modurl modname='Wikula' func='main' tag=$tag time=$oldest.time|dateformat|@urlencode}" title="{$tag|safehtml} - {$oldest.time|dateformat|safehtml}">{$oldest.time|dateformat|safehtml}</a>
