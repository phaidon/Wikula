...
<div id="wikula">
    <div class="page">
        ...
        <form class="z-form" action="{modurl modname='wikula' type='user' func='Referrers' tag=$tag|urlencode}" method="post" enctype="application/x-www-form-urlencoded" id="form_refform">
            <div>
