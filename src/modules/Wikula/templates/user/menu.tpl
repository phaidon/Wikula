    ...
    <div class="header">
        ...
        <div class="z-clearfix">
            <ul class="z-menulinks">
                ...
                {/if}
                <li class="z-floatright" style="height:26px; border-right: none;">
                    <form class="z-form" action="{modurl modname=$modinfo.name type='user' func='main' __tag='Search'}" method="post" enctype="application/x-www-form-urlencoded">
                        <div>
                            ...
                            <button id="searchButton" type="submit" name="button" class="wikula_searchbutton">{img modname=core src=search.png set=icons/extrasmall width="12" height=12"}</button>
                        </div>
                    </form>
                </li>
            </ul>
