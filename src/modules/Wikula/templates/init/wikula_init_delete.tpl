...
<div class="z--admincontainer" style="text-align:center;">
    <div class="z--adminpageicon">{img modname='core' src='package.gif' set='icons/large' __alt='Deinstallation of Wikula' }</div>
